...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'sqlite:///retour_produits.db'
    ...
    APP_NAME = "Gestion des Retours Produits"
    ITEMS_PER_PAGE = 10
    ...
    def init_app(app):
        ...
        def internal_error(error):
            try:
                ...
                pass  # Ignore l'erreur si db n'est pas disponible
